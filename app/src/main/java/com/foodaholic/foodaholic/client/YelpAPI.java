...
public class YelpAPI {
     ...
     */
    private static final String CONSUMER_KEY = "VPhd3F7LAajnYgdTlAf_vQ";
    private static final String CONSUMER_SECRET = "JEAUwvEEtZbCMRW7JXQzJGni4yQ";
    private static final String TOKEN = "qsdX-Z0HYz9L5iICBafvdCGrA_40o5Qi";
    private static final String TOKEN_SECRET = "WQnOeZCzGGAQ3Ce8MwFet4a7_4A";
